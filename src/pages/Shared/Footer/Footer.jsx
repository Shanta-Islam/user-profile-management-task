...
const Footer = () => {
    return (
        <div>
            <footer className="relative pt-8 pb-6 text-black">
                <div className="container mx-auto px-4">
                    <div className="flex flex-wrap text-left lg:text-left">
                        <div className="w-full lg:w-6/12 px-4">
                            <a href='/' className="normal-case flex gap-2 text-3xl font-medium text-white mb-5">Taskia</a>
                            <h4 className="text-3xl fonat-semibold text-blueGray-700">Let's keep in touch!</h4>
                            <h5 className="text-lg mt-0 mb-2 text-blueGray-600">
                                Find us on any of these platforms, we respond 1-2 business days.
                            </h5>
                            <div className="mt-6 lg:mb-0 mb-6 flex justify-start gap-5">
                                <a href="https://web.facebook.com/"><button><FaFacebook></FaFacebook></button></a>
                                <a href="https://github.com/"><button><FaGithub></FaGithub></button></a>
                                <a href="https://linkedin.com/"><button><FaLinkedin ></FaLinkedin></button></a>
                            </div>
                        </div>
                        <div className="w-full lg:w-6/12 px-4">
